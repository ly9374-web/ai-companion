...
class ToolExecutor:
        ...
        if isinstance(call, ToolCallObject):
            ...
            try:
                ...
                result_content = prompt_builder.load_runtime_prompt(
                    "tool_invalid_arguments", tool_name=tool_name
                )
                is_error = True
                parse_error = True
    ...
    def format_tool_result(
        ...
        if caller_mode == "Claude":
            ...
            if isinstance(result_content, list):
                ...
                content_to_send = prompt_builder.load_runtime_prompt(
        ...
        for call in tool_calls:
            ...
            if content_items:
                ...
                if image_items:
                    ...
                    status_content = prompt_builder.load_runtime_prompt(
                        "tool_images_returned",
                        text=text_content,
    ...
    async def run_single_tool(
        ...
        if not tool_info:
            ...
            text_content = prompt_builder.load_runtime_prompt(
                "tool_unavailable", tool_name=tool_name
            )
            ...
            text_content = prompt_builder.load_runtime_prompt(
                "tool_missing_server", tool_name=tool_name
            )
            content_items = [{"type": "error", "text": text_content}]
            is_error = True
        else:
            try:
                ...
                if content_items and content_items[0].get("type") == "error":
                    ...
                    text_content = content_items[0].get(
                        "text",
                        prompt_builder.load_runtime_prompt("tool_unknown_error"),
                    )
                ...
                text_content = prompt_builder.load_runtime_prompt(
                    "tool_execution_error", tool_name=tool_name, error=e
                )
                content_items = [{"type": "error", "text": text_content}]
                is_error = True
            except Exception as e:
                ...
                text_content = prompt_builder.load_runtime_prompt(
                    "tool_unexpected_error", tool_name=tool_name, error=e
                )
                content_items = [{"type": "error", "text": text_content}]
                is_error = True
